...
public class ConverterFragment extends Fragment {
    ...
    private TextView sourceCurrencySymbolText;
    private TextView sourceCurrencySymbolName;

    private TextView destinationCurrencySymbolText;
    private TextView destinationCurrencySymbolName;
...
//                .debounce(500, TimeUnit.MILLISECONDS)
    ...
    private void bindCurrency(String currency, TextView symbolText, TextView currencyName) {
        ...
        symbolText.setText(String.valueOf(currency.charAt(0)));
